defmodule DBF.FixtureManifest do
  ...
  @fixtures [
    ...
    %{
      id: :visual_foxpro_vfp9_binary_fields,
      files: %{
        table: "test/dbf_files/vfp9_binary.dbf",
        memo: "test/dbf_files/vfp9_binary.fpt"
      },
      profile: %{
        format: :visual_foxpro_vfp9,
        version: 0x32,
        memo: :fpt,
        encoding: {:ldid, 0x03}
      },
      provenance: %{
        producer: "Microsoft Visual FoxPro 9.0.00.5815 via VFPOLEDB",
        origin: "tools/fixtures/vfp9/generate.ps1",
        redistribution: :project_generated
      },
      support: :verified,
      exercise: {:open, %{records: 4, fields: 7}},
      expected_values: {:generator, "tools/fixtures/vfp9/generate.ps1"},
      normative_sources: [:visual_foxpro, :visual_foxpro_fpt],
      notes: [
        "Generated by GitHub Actions run 33749640855.",
        "Covers Varchar, Varbinary, binary Character, binary Memo, Blob, Double, null, empty, deleted, and multi-block values."
      ]
    },
    %{
