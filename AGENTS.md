...
- The file `docs/DBF-Format.md` includes notes about the file format, references about it and example projects. If you find valuable notes to jot down for future agents you can use that file.
