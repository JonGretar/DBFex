...
| FoxPro 2.x for DOS/Windows with FPT | `0xF5`                         | Verified    | Legacy fields, textual Memo, decimal FPT pointers, and type-2 General/OLE payloads are covered. Macintosh type-0 Picture-in-General files remain unevidenced.     |
| Visual FoxPro tables/FPT            | `0x30`                         | Verified    | Fixed-width fields, integer, double, timestamp, text/binary Memo, and opaque Picture and General/OLE FPT payloads are covered.                                    |
| Visual FoxPro autoincrement          | `0x31`                         | Verified    | Autoincrement metadata, exact currency, nullable fields, and complete fixture enumeration are covered.                                                           |
| Visual FoxPro variable-width         | `0x32`                         | Verified    | Varchar, Varbinary, binary Character/Memo, Blob, Double, stored lengths, null/empty states, deleted records, and multi-block payloads are covered.                |
