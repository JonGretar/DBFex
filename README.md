...
| Visual FoxPro tables/FPT            | `0x30`                         | Partial     | Fixed-width legacy, integer, timestamp, textual FPT memo, and type-0 Picture payloads are covered; General/OLE object blocks and broader VFP9 binary types remain unsupported. |
...
| Visual FoxPro variable-width         | `0x32`                         | Partial     | Textual and binary `V` values, stored-length bits, null precedence, full-width values, and malformed lengths are covered.                                        |
