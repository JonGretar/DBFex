...
| Visual FoxPro tables/FPT            | `0x30`                         | Partial     | Fixed-width legacy, integer, timestamp, textual FPT memo, and binary Picture/General values are covered; nullable, currency, and database-container values remain unsupported. |
